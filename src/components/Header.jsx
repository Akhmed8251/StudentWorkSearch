      ...
      <div className="header__container container">
        <div className="logo">
          ...
          <div className="logo__text">
            Репозитории студенческих работ
          </div>
        </div>
          ...
          {userName && (
            <>
              <button
                ...
                className={`action__btn${userName ? " logout" : ""}`}
              ></button>
